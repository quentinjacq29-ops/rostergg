...
import OnbStep7Style from '@/components/onboarding/OnbStep6Style'
import OnbStep8Availability from '@/components/onboarding/OnbStep7Availability'

type Props = { params: { locale: string; step: string } }

export default function OnboardingStepPage({ params: { locale, step } }: Props) {
  const n = parseInt(step, 10)
  if (isNaN(n) || n < 1 || n > 8) redirect(`/${locale}/onboarding/1`)
  ...
  switch (n) {
    ...
    case 7: return <OnbStep7Style {...props} />
    case 8: return <OnbStep8Availability {...props} />
